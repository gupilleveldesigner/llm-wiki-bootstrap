...
def install_game_overlay(
    ...
    *,
    ...
    proposals = [*skill_proposals, *template_proposals, *doc_proposals, *router_proposals]
    return {
        ...
        "project_mode_activation_pending": verification["status"] == "pending" or bool(proposals),
